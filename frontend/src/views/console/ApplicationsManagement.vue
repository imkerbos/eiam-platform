  ...
  <div class="applications-management">
      ...
      >
        ...
        <div v-if="formData.type === 'oauth2'">
          ...
          <a-form-item label="Redirect URIs" name="redirectUris">
            <a-textarea v-model:value="formData.config.redirectUris" :rows="3" placeholder="EnterRedirect URIs (one per line)" />
          </a-form-item>
          <a-form-item label="Scopes" name="scopes">
            <a-select v-model:value="formData.config.scopes" mode="multiple" placeholder="SelectScopes">
        ...
        <div v-if="formData.type === 'saml'">
          <a-form-item label="Entity ID" name="entityId">
            <a-input v-model:value="formData.config.entityId" placeholder="EnterEntity ID" />
          </a-form-item>
          <a-form-item label="ACS URL" name="acsUrl">
            <a-input v-model:value="formData.config.acsUrl" placeholder="EnterACS URL" />
          </a-form-item>
          <a-form-item label="SLO URL" name="sloUrl">
            <a-input v-model:value="formData.config.sloUrl" placeholder="EnterSLO URL" />
          </a-form-item>
          <a-form-item label="Certificate" name="certificate">
            <a-textarea v-model:value="formData.config.certificate" :rows="5" placeholder="EnterCertificate" />
          </a-form-item>
          <a-row :gutter="16">
            <a-col :span="12">
        ...
        <div v-if="formData.type === 'cas'">
          <a-form-item label="Service URL" name="serviceUrl">
            <a-input v-model:value="formData.config.serviceUrl" placeholder="EnterService URL" />
          </a-form-item>
          <a-form-item label="Gateway Mode" name="gateway">
            <a-switch v-model:checked="formData.config.gateway" />
          </a-form-item>
          <a-form-item label="Re-authentication" name="renew">
        ...
        <div v-if="formData.type === 'oidc'">
          <a-row :gutter="16">
            <a-col :span="12">
              <a-form-item label="Client ID" name="clientId">
                <a-input v-model:value="formData.config.clientId" placeholder="EnterClient ID" />
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item label="Client Secret" name="clientSecret">
                <a-input-password v-model:value="formData.config.clientSecret" placeholder="EnterClient Secret" />
              </a-form-item>
            </a-col>
          </a-row>
          <a-form-item label="Redirect URIs" name="redirectUris">
          ...
          <a-form-item label="Grant Types" name="grantTypes">
            <a-select v-model:value="formData.config.grantTypes" mode="multiple" placeholder="SelectGrant Types">
          ...
          <a-form-item label="Response Types" name="responseTypes">
            <a-select v-model:value="formData.config.responseTypes" mode="multiple" placeholder="SelectResponse Types">
        ...
        <div v-if="formData.type === 'ldap'">
          <a-form-item label="LDAP URL" name="ldapUrl">
            <a-input v-model:value="formData.config.ldapUrl" placeholder="EnterLDAP URL" />
          </a-form-item>
          <a-form-item label="Base DN" name="baseDn">
            <a-input v-model:value="formData.config.baseDn" placeholder="EnterBase DN" />
          </a-form-item>
          <a-form-item label="Bind DN" name="bindDn">
            <a-input v-model:value="formData.config.bindDn" placeholder="EnterBind DN" />
          </a-form-item>
          <a-form-item label="Bind Password" name="bindPassword">
            <a-input-password v-model:value="formData.config.bindPassword" placeholder="EnterBind Password" />
          </a-form-item>
        </div>
      </a-form>
    </a-modal>
    ...
    >
      <a-tabs v-model:activeKey="activeConfigTab">
        ...
        <a-tab-pane key="cas" tab="CAS Configuration">
          <a-form layout="vertical">
            <a-form-item label="Service URL">
              <a-input v-model:value="configData.cas.serviceUrl" placeholder="EnterService URL" />
            </a-form-item>
            <a-form-item label="Gateway Mode">
              <a-switch v-model:checked="configData.cas.gateway" />
              <div class="text-gray-500 text-sm mt-1">Enable gateway mode for automatic authentication</div>
            </a-form-item>
            <a-form-item label="Re-authentication">
              <a-switch v-model:checked="configData.cas.renew" />
              <div class="text-gray-500 text-sm mt-1">Force re-authentication even if user is already logged in</div>
            </a-form-item>
          </a-form>
        </a-tab-pane>
